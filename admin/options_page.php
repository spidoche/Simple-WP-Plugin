    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input id="text01" name="prefix_[text01]" type="text" value="<?php if(isset($options['text01'])){ echo esc_attr($options['text01']);} ?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="hidden" name="prefix_[upload]" id="prefix_upload_url" value="<?php if(isset($options['upload'])){ echo esc_attr($options['upload']);} ?>" />
